...
<div class="comment-form-container">
    ...
    <?php echo $form->field($commentModel, 'content', ['template' => '{input}{error}'])->textarea(['placeholder' => Yii::t('yii2mod.comments', 'Добавить комментарий...'), 'rows' => 4, 'data' => ['comment' => 'content']]) ?>
